...
if (isset($tpl['status']))
{
	...
	?>
	<?php 
	pjUtil::printNotice(__('infoNotesTitle', true, false), __('infoNotesBody', true, false)); 
	?>
	<div class="b10">
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get" class="float_left pj-form r10">
			<input type="hidden" name="controller" value="pjAdminNotes" />
			<input type="hidden" name="action" value="pjActionCreate" />
			<input type="submit" class="pj-button" value="+ <?php __('lblAddNote'); ?>" />
		</form>
	...
	var myLabel = myLabel || {};
	myLabel.name = "<?php __('lblNoteName'); ?>";
