...
if (isset($tpl['status']))
{
    ...
    pjUtil::printNotice(__('infoAddNoteTitle', true, false), __('infoAddNoteBody', true, false), false); 
	...
	<div class="clear_both">
    	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminNotes&amp;action=pjActionCreate" method="post" id="frmCreate" class="form pj-form" autocomplete="off">
            ...
            foreach ($tpl['lp_arr'] as $v)
            {
                ...
                <p class="pj-multilang-wrap" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : NULL; ?>">
    				...
    				<span class="inline_block">
    					<textarea name="i18n[<?php echo $v['id']; ?>][body]" class="pj-form-field w550 h300"></textarea>
    					<?php if ((int) $tpl['option_arr']['o_multi_lang'] === 1 && count($tpl['lp_arr']) > 1) : ?>
                            <span class="pj-multilang-input"><img src="<?php echo PJ_INSTALL_URL . PJ_FRAMEWORK_LIBS_PATH . 'pj/img/flags/' . $v['file']; ?>" alt="" /></span>
                        <?php endif;?>
    				</span>
