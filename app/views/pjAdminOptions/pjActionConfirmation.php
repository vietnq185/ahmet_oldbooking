					...
					<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminOptions&amp;action=pjActionUpdate" method="post" class="form pj-form">
						...
						<div id="tabs">
							<ul>
								...
								<li><a href="#tabs-3"><?php __('lblDriver');?></a></li>
							</ul>
							<div id="tabs-1">
								<?php
										...
										<tbody>
											...
											for ($i = 0; $i < $count; $i++)
											{
												if ($tpl['arr'][$i]['tab_id'] == 3 && (int) $tpl['arr'][$i]['is_visible'] === 1 && (strpos($tpl['arr'][$i]['key'], 'admin') === false) && (strpos($tpl['arr'][$i]['key'], 'email') > -1))
												{
													...
													if (in_array($tpl['arr'][$i]['key'], array('o_email_arrival_confirmation_subject', 'o_email_arrival_confirmation_message')))
													{
														$rowClass = " boxClientArrivalConfirmation";
														$rowStyle = "display: none";
														switch ($tpl['option_arr']['o_email_arrival_confirmation'])
														{
															case '1':
																$rowStyle = NULL;
																break;
													...
													if (in_array($tpl['arr'][$i]['key'], array('o_email_client_account_subject', 'o_email_client_account_message')))
													{
														$rowClass = " boxClientAccount";
														$rowStyle = "display: none";
														switch ($tpl['option_arr']['o_email_client_account'])
														{
															case '1':
																$rowStyle = NULL;
																break;
                                                    ...
                                                    if (in_array($tpl['arr'][$i]['key'], array('o_email_reminder_subject', 'o_email_reminder_message')))
                                                    {
                                                        $rowClass = " boxClientReminder";
                                                        $rowStyle = "display: none";
                                                        switch ($tpl['option_arr']['o_email_reminder'])
                                                        {
                                                            case '1':
                                                                $rowStyle = NULL;
                                                                break;
                                                    ...
                                                    if (in_array($tpl['arr'][$i]['key'], array('o_email_return_reminder_subject', 'o_email_return_reminder_message')))
                                                    {
                                                        $rowClass = " boxClientReturnReminder";
                                                        $rowStyle = "display: none";
                                                        switch ($tpl['option_arr']['o_email_return_reminder'])
                                                        {
                                                            case '1':
                                                                $rowStyle = NULL;
                                                                break;
                                                    ...
                                                    if (in_array($tpl['arr'][$i]['key'], array('o_email_payment_link_subject', 'o_email_payment_link_message')))
                                                    {
                                                        $rowClass = " boxClientSendPaymentLink";
                                                        $rowStyle = "display: none";
                                                        switch ($tpl['option_arr']['o_email_payment_link_confirmation'])
                                                        {
                                                            case '1':
                                                                $rowStyle = NULL;
                                                                break;
													...
													<tr class="pj-table-row-odd<?php echo $rowClass; ?>" style="<?php echo $rowStyle; ?>">
														<td width="35%" valign="top">
															...
															<span class="fs10">
																<?php 
																if(in_array($tpl['arr'][$i]['key'], array('o_email_confirmation','o_email_payment','o_email_cancel', 'o_email_client_account', 'o_email_client_account_message', 'o_email_forgot_message', 'o_email_reminder', 'o_email_return_reminder', 'o_email_arrival_confirmation', 'o_email_payment_link_message')))
																{
															...
															switch ($tpl['arr'][$i]['type'])
															{
																...
																case 'text':
																	...
																	<?php
																		...
																		<textarea name="value-<?php echo $tpl['arr'][$i]['type']; ?>-<?php echo $tpl['arr'][$i]['key']; ?>" class="pj-form-field" style="width: 600px; height: 400px;"><?php echo htmlspecialchars(stripslashes($tpl['arr'][$i]['value'])); ?></textarea>
																	<?php }
												...
												if ($tpl['arr'][$i]['tab_id'] == 3 && (int) $tpl['arr'][$i]['is_visible'] === 1 && (strpos($tpl['arr'][$i]['key'], 'admin') === false) && (strpos($tpl['arr'][$i]['key'], 'sms') > -1))
												{
													...
													<tr class="pj-table-row-odd<?php echo $rowClass; ?>" style="<?php echo $rowStyle; ?>">
														<td width="35%" valign="top">
															...
															<span class="fs10">
																<?php 
																if(in_array($tpl['arr'][$i]['key'], array('o_sms_confirmation_message', 'o_sms_reminder_message', 'o_sms_return_reminder_message')))
																{
																	...
																	?>
																		<?php
																			foreach ($tpl['lp_arr'] as $v)
																			{
																				...
																				<p class="pj-multilang-wrap" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : NULL; ?>">
																					<span class="inline_block">
																						<textarea name="i18n[<?php echo $v['id']; ?>][<?php echo $tpl['arr'][$i]['key'] ?>]" class="pj-form-field" style="width: 600px; height: 200px;"><?php echo htmlspecialchars(stripslashes(@$tpl['arr']['i18n'][$v['id']][$tpl['arr'][$i]['key']])); ?></textarea>
																						<?php if ((int) $tpl['option_arr']['o_multi_lang'] === 1 && count($tpl['lp_arr']) > 1) : ?>
																						<span class="pj-multilang-input"><img src="<?php echo PJ_INSTALL_URL . PJ_FRAMEWORK_LIBS_PATH . 'pj/img/flags/' . $v['file']; ?>" alt="" /></span>
																						<?php endif;?>
																					</span>
										...
										<tbody>
											...
											for ($i = 0; $i < $count; $i++)
											{
												...
												{											
													...
													if (in_array($tpl['arr'][$i]['key'], array('o_admin_email_arrival_confirmation_subject', 'o_admin_email_arrival_confirmation_message')))
													{
														$rowClass = " boxAdminArrivalConfirmation";
														$rowStyle = "display: none";
														switch ($tpl['option_arr']['o_admin_email_arrival_confirmation'])
														{
															case '1':
																$rowStyle = NULL;
																break;
													...
													if (in_array($tpl['arr'][$i]['key'], array('o_admin_email_client_account_subject', 'o_admin_email_client_account_message')))
													{
														$rowClass = " boxAdminClientAccount";
														$rowStyle = "display: none";
														switch ($tpl['option_arr']['o_admin_email_client_account'])
														{
															case '1':
																$rowStyle = NULL;
																break;
													...
													<tr class="pj-table-row-odd<?php echo $rowClass; ?>" style="<?php echo $rowStyle; ?>">
														<td width="35%" valign="top">
															...
															<span class="fs10">
																<?php 
																if(in_array($tpl['arr'][$i]['key'], array('o_admin_email_confirmation','o_admin_email_payment','o_admin_email_cancel', 'o_admin_email_client_account', 'o_admin_email_client_account_message', 'o_admin_email_arrival_confirmation')))
																{
																	nl2br(__('opt_' . $tpl['arr'][$i]['key'].'_text'));
																} 
																?>
														...
														<td valign="top">
															...
															{
																case 'string':
																	if(in_array($tpl['arr'][$i]['key'], array('o_admin_email_confirmation_subject','o_admin_email_payment_subject','o_admin_email_cancel_subject', 'o_admin_email_client_account_subject', 'o_admin_email_arrival_confirmation_subject')))
																	{
																	?>
																		<?php
																			foreach ($tpl['lp_arr'] as $v)
																...
																case 'text':
																	...
																	if(in_array($tpl['arr'][$i]['key'], array('o_admin_email_confirmation_message','o_admin_email_payment_message','o_admin_email_cancel_message', 'o_admin_email_client_account_message', 'o_admin_email_arrival_confirmation_message')))
																	{
																	?>
																		<?php
																			foreach ($tpl['lp_arr'] as $v)
																			{
																				...
																				<p class="pj-multilang-wrap" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : NULL; ?>">
																					<span class="inline_block">
																						<textarea name="i18n[<?php echo $v['id']; ?>][<?php echo $tpl['arr'][$i]['key'] ?>]" class="pj-form-field mceEditor" style="width: 600px; height: 400px;"><?php echo htmlspecialchars(stripslashes(@$tpl['arr']['i18n'][$v['id']][$tpl['arr'][$i]['key']])); ?></textarea>
																						<?php if ((int) $tpl['option_arr']['o_multi_lang'] === 1 && count($tpl['lp_arr']) > 1) : ?>
																						<span class="pj-multilang-input"><img src="<?php echo PJ_INSTALL_URL . PJ_FRAMEWORK_LIBS_PATH . 'pj/img/flags/' . $v['file']; ?>" alt="" /></span>
																						<?php endif;?>
																					</span>
															...
															switch ($tpl['arr'][$i]['type'])
															{
																...
																case 'text':
																	...
																	<?php
																		...
																		<textarea name="value-<?php echo $tpl['arr'][$i]['type']; ?>-<?php echo $tpl['arr'][$i]['key']; ?>" class="pj-form-field" style="width: 600px; height: 200px;"><?php echo htmlspecialchars(stripslashes($tpl['arr'][$i]['value'])); ?></textarea>
																	<?php }
                            ...
                            <div id="tabs-3">
                                ...
                                <fieldset class="fieldset white">
                                    ...
                                    <table class="pj-table" cellpadding="0" cellspacing="0" style="width: 100%">
                                        ...
                                        for ($i = 0; $i < $count; $i++)
                                        {
                                            if ($tpl['arr'][$i]['tab_id'] == 6 && (int) $tpl['arr'][$i]['is_visible'] === 1 && (strpos($tpl['arr'][$i]['key'], 'admin') === false) && (strpos($tpl['arr'][$i]['key'], 'email') > -1))
                                            {

                                                $rowClass = NULL;
                                                $rowStyle = NULL;
                                                if (in_array($tpl['arr'][$i]['key'], array('o_email_driver_subject', 'o_email_driver_message')))
                                                {
                                                    $rowClass = " boxDriver";
                                                    $rowStyle = "display: none";
                                                    switch ($tpl['option_arr']['o_email_driver'])
                                                    {
                                                        case '1':
                                                            $rowStyle = NULL;
                                                            break;
                                                ...
                                                <tr class="pj-table-row-odd<?php echo $rowClass; ?>" style="<?php echo $rowStyle; ?>">
                                                    <td width="35%" valign="top">
                                                        <span class="block bold"><?php __('opt_' . $tpl['arr'][$i]['key']); ?></span>
															<span class="fs10">
																<?php
                                                                if(in_array($tpl['arr'][$i]['key'], array('o_email_driver')))
                                                                {
                                                                    nl2br(__('opt_' . $tpl['arr'][$i]['key'].'_text'));
                                                                }
                                                                ?>
                                                    ...
                                                    <td valign="top">
                                                        ...
                                                        {
                                                            case 'string':
                                                                if(in_array($tpl['arr'][$i]['key'], array('o_email_driver_subject')))
                                                                {
                                                                    ?>
                                                                    <?php
                                                                    foreach ($tpl['lp_arr'] as $v)
                                                            ...
                                                            case 'text':
                                                                ...
                                                                if(in_array($tpl['arr'][$i]['key'], array('o_email_driver_message')))
                                                                {
                                                                    ?>
                                                                    <?php
                                                                    foreach ($tpl['lp_arr'] as $v)
                                                                    ...
                                                                    <textarea name="value-<?php echo $tpl['arr'][$i]['type']; ?>-<?php echo $tpl['arr'][$i]['key']; ?>" class="pj-form-field" style="width: 460px; height: 600px;"><?php echo htmlspecialchars(stripslashes($tpl['arr'][$i]['value'])); ?></textarea>
                                                                <?php }
