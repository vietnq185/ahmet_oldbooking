...
if (isset($tpl['status']))
{
    ...
    pjUtil::printNotice(__('infoAddInquiryTemplateTitle', true, false), __('infoAddInquiryTemplateBody', true, false), false); 
	...
	<div class="clear_both">
    	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminInquiryTemplates&amp;action=pjActionCreate" method="post" id="frmCreate" class="form pj-form frmArea" autocomplete="off">
