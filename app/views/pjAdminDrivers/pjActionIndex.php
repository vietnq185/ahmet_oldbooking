...
if (isset($tpl['status']))
{
	...
	pjUtil::printNotice(__('infoDriversTitle', true, false), __('infoDriversBody', true, false));
	?>
	<div class="b10">
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get" class="float_left pj-form r10">
			<input type="hidden" name="controller" value="pjAdminDrivers" />
			<input type="hidden" name="action" value="pjActionCreate" />
			<input type="submit" class="pj-button" value="<?php __('btnAddDriver'); ?>" />
		</form>
	...
	myLabel.enquiries = "<?php __('lblEnquiries', false, true); ?>";
