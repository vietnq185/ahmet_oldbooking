...
if (isset($tpl['status']))
{
	...
	pjUtil::printNotice(__('infoEmailThemesTitle', true, false), __('infoEmailThemesBody', true, false)); 
	?>
	<div class="b10">
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get" class="float_left pj-form r10">
			<input type="hidden" name="controller" value="pjAdminEmailThemes" />
			<input type="hidden" name="action" value="pjActionCreate" />
			<input type="submit" class="pj-button" value="+ <?php __('lblAddEmailTheme'); ?>" />
		</form>
	...
	var myLabel = myLabel || {};
	myLabel.name = "<?php __('lblEmailThemeName'); ?>";
