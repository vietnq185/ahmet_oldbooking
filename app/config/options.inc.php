...
if (!defined("PJ_SCRIPT_BUILD")) define("PJ_SCRIPT_BUILD", "1.1.2");
if (!defined("PJ_SCRIPT_PREFIX")) define("PJ_SCRIPT_PREFIX", "transfer_reservation_");
...
$CONFIG = array();
$CONFIG['plugins'] = array('pjLocale', 'pjBackup', 'pjLog', 'pjInstaller', 'pjOneAdmin', 'pjCountry', 'pjSms', 'pjPaypal', 'pjAuthorize', 'pjInvoice');
?>